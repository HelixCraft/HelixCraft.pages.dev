        ...
        <div>
          ...
          <div class="hero-links">
            <a class="btn btn-ghost" href="https://github.com/HelixCraft" target="_blank">
              <img class="simple-icon" src="https://cdn.simpleicons.org/github" alt="GitHub" width="13" height="13">
              GitHub
            </a>
            <a class="btn btn-ghost" href="https://modrinth.com/user/HelixCraft" target="_blank">
              <img class="simple-icon" src="https://cdn.simpleicons.org/modrinth" alt="Modrinth" width="13" height="13">
              Modrinth
            </a>
            <a class="btn btn-ghost" href="https://discordapp.com/users/1502297205845790781" target="_blank">
              <img class="simple-icon" src="https://cdn.simpleicons.org/discord" alt="Discord" width="13" height="13">
              Discord
            </a>
            <a class="btn btn-ghost" href="mailto:HelixCraft@tuta.io">
              <img class="simple-icon" src="https://cdn.simpleicons.org/gmail" alt="Email" width="13" height="13">
              Email
            </a>
          </div>
        </div>
  ...
  about: () => `
    <div class="wrap">
      ...
      <a class="social-link" href="https://modrinth.com/user/HelixCraft" target="_blank">
        <img class="simple-icon" src="https://cdn.simpleicons.org/modrinth" alt="Modrinth" width="17" height="17">
      ...
      <a class="social-link" href="https://github.com/HelixCraft" target="_blank">
        <img class="simple-icon" src="https://cdn.simpleicons.org/github" alt="GitHub" width="17" height="17">
        <div class="social-text"><strong>GitHub</strong>github.com/HelixCraft</div>
      </a>
      <a class="social-link" href="https://discordapp.com/users/1502297205845790781" target="_blank">
        <img class="simple-icon" src="https://cdn.simpleicons.org/discord" alt="Discord" width="17" height="17">
        <div class="social-text"><strong>Discord</strong>1502297205845790781</div>
      </a>
      <a class="social-link" href="mailto:HelixCraft@tuta.io">
        <img class="simple-icon" src="https://cdn.simpleicons.org/gmail" alt="Email" width="17" height="17">
        <div class="social-text"><strong>Email</strong>HelixCraft@tuta.io</div>
      </a>
    </div>
  `,
  donate: () => `
    <div class="wrap">
      ...
      <div class="donate-contact">
        If you have any problems, contact me on Discord: <a href="https://discordapp.com/users/1502297205845790781" target="_blank" rel="noopener noreferrer">@mchc8</a>
      </div>
    </div>
  `,
};
